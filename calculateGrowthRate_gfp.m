...
% last updated: jen, 2022 Jan 19

% commit: for juani's gfp experiments

% Go go let's go!

%%
function [growthRates] = calculateGrowthRate_gfp(volumes,isDrop,trackNum,dt_sec)
